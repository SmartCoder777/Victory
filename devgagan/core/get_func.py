...
def get_user_rename_preference(user_id):
    # Retrieve the user's custom renaming tag if set, or default to 'VictoryAnthem'
    return user_rename_preferences.get(str(user_id), 'VictoryAnthem')
...
async def settings_command(event):
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/VictoryAnthem")]
    ]
